...
document.getElementById("tp-rc").addEventListener("click", function () {
    document.getElementById("page2").scrollIntoView({
      behavior: "smooth" // enables smooth scrolling
    });
  });
  document.getElementById("ad-gf").addEventListener("click", function () {
    document.getElementById("page3").scrollIntoView({
      behavior: "smooth" // enables smooth scrolling
    });
  });
  document.getElementById("tp-gf").addEventListener("click", function () {
